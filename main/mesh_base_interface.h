...
public:
    ...
    virtual MeshProto::MeshPacket* alloc_near_packet(MeshProto::MeshPacketType type, uint size) const = 0;
    ...
    virtual MeshProto::MeshPacket* realloc_near_packet(MeshProto::MeshPacket* packet,
                                                       ...
                                                       uint new_size) const = 0;

    virtual void free_near_packet(MeshProto::MeshPacket* packet) const = 0;
    ...
    virtual void write_addr_bytes(MeshPhyAddrPtr phy_addr, void* out_buf) const = 0;
